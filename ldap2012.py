...
def ldapSetup(ldapdomain,
    ...
    # driver.find_element_by_id("organizational-unit").clear()
    # driver.find_element_by_id("organizational-unit").send_keys(orgunit)

    # driver.find_element_by_id("uid-key").clear()
    # driver.find_element_by_id("uid-key").send_keys(uidkey)
...
# Active Directory 2012 options.
    ldapSetup(AD12svr[0],
          ...
          AD12usr[1][2],
          AD12usr[2][2],
          AD12usr[3][2])     # configure the TQ server for using ldap
except Exception as e:
    logger.info (e)
    print (e)
