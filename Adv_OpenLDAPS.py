...
openLDAPusers = [
             ["admin@threatq.com", "ChangeMePlease!", "administrator"],
             ["Super@threatq.com", "ChangeMePlease!", "ldapSuper"],
             ["Analyst@threatq.com", "ChangeMePlease!", "ldapAnalyst"],
             ["Observer@threatq.com", "ChangeMePlease!", "ldapObserver"]
                ]
