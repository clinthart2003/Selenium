...
def spearphish(efile=r'/files/Events/ChronArte_events_12_spearfish_objects_Apr.txt'):
    ...
    driver.find_element_by_xpath("//button[@class='btn success pull-right ng-isolate-scope']").click()
    ...
    driver.find_element_by_xpath("//button[@ng-click='submit()']").click()
...
months = [["September", "2019"],["October", "2019"],["August", "2019"], ["May", "2019"], ["June", "2019"], ["January", "2019"],
