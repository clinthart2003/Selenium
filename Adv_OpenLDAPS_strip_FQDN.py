...
openLDAPusers = [
             ["uid=admin@threatq.com,ou=People,dc=threatq,dc=com", "threatquotientthreatquotient", "administrator"],
             ["uid=Super@threatq.com,ou=People,dc=threatq,dc=com", "threatquotientthreatquotient", "ldapSuper"],
             ["uid=Analyst@threatq.com,ou=People,dc=threatq,dc=com", "threatquotientthreatquotient", "ldapAnalyst"],
             ["uid=Observer@threatq.com,ou=People,dc=threatq,dc=com", "threatquotientthreatquotient", "ldapObserver"]
                ]

openLDAPserver = ["", "tqldap.threatq.com", "636", "uid=admin@threatq.com,ou=People,dc=threatq,dc=com",
                  "threatquotientthreatquotient", "DC=threatq,DC=com", "dn", "objectClass=posixAccount",
                  "objectClass=posixGroup", "memberUid", "cn", "uid", "memberUid"
                  ]
