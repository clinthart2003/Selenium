...
def server_config():
    ...
    driver.find_element_by_id("username-field").send_keys('testingsmtptestingsmtp@gmail.com')

    # from_email
    driver.find_element_by_id("from-address-field").clear()
    driver.find_element_by_id("from-address-field").send_keys('testingsmtptestingsmtp@gmail.com')
